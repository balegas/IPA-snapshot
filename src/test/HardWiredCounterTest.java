...
// AnalysisContext.getNewContext(spec.getOperations(),
// GenericConflictResolutionPolicy.getDefault(),
// GenericPredicateFactory.getFactory());
// rootContext.registerContraint(DummySpec.effect2);
// analyzer.testIdempotence(new SingleOperationTest(DummySpec.op1Name),
// rootContext.childContext(false));
// }
//
// }
//
...
//
// Invariant invariant = new JavaInvariantClause("forall( Int : x ) :- Value(x)
// <= 20");
//
// static Invariant constraint = new JavaInvariantClause("forall( Int : x ) :-
// Value(x) <= 20");
//
...
//
// static List<Parameter> params = ImmutableList.of(new GenericVariable("arg",
// "Int"));
//
// String predicate2Name = "#Value";
//
// PredicateAssignment effect1 = new GenericPredicateAssignment(op1Name,
// predicate1Name,
// new GenericConstant(PREDICATE_TYPE.Int, "1"), params);
//
// static ConditionPredicateAssignment effect2 = new
// ConditionPredicateAssignment(predicate1Name, params, constraint);
//
...
//
// @Override
// public Invariant invariantFor(Collection<String> asSet, AnalysisContext
// context) {
// return invariant;
// }
// }
